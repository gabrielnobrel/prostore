  ...
  return (
    <div className="grid md:grid-cols-5 md:gap-5">
      <div className="filter-links">
        {/* Category Links */}
        <div className="text-xl md-2 mt-3">Department</div>
        <div>
        ...
        {/* Price Links */}
        <div className="text-xl md-2 mt-8">Price</div>
        <div>
          <ul className="space-y-1">
            <li>
              <Link
        ...
        {/* Rating Links */}
        <div className="text-xl md-2 mt-8">Customer Ratings</div>
        <div>
          <ul className="space-y-1">
            <li>
              <Link
      ...
      <div className="md:col-span-4 space-y-4">
        <div className="flex-between flex-col my-4 md:flex-row justify-center">
